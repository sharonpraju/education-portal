                    ...
                    <div class="d-flex justify-content-center">
                        ...
                        <div class="col-xl-8 col-lg-7">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <input type="text" class="form-control" id="description"
                                                    placeholder="Description ( Eg: 2nd Standard )">
                                            </div>
                                        </div>
                                        <br>
                                        <div class="row">
                            ...
                            while( $row = mysqli_fetch_assoc($resultset) ) { ?>
                                            ...
                                            <div class="col">
                                                <br>
                                                If the teacher is not listed. Please make sure you have added the
                                                particular teacher as a user.
                                                If you haven't done this, <a href="add_users.php?user=teacher"> Add a
                                                    teacher now</a>.
                                            </div>
                                        </div>
                                        <div class="row">
