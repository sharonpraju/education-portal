<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow mx-1">
            <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button" data-toggle="dropdown"
                ...
                <!-- Counter - Alerts -->
                <span id="displaystatus" class="badge badge-danger badge-counter" style="font-size: 15px"></span>
            </a>
            <!-- Dropdown - Alerts -->
            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                    ...
                    <div>
                        ...
                        <span id="newassignment" class="font-weight-bold">Test Submission</span>
                    </div>
                </a>
                <a class="dropdown-item d-flex align-items-center" href="#">
                    <div class="mr-3">
        ...
        <li class="nav-item dropdown no-arrow mx-1">
            <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown warningclick" role="button"
                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <i id="warningclick" class="fa fa-exclamation-triangle"></i>
                <!-- Counter - Alerts -->



                <!-- Warning Drop Shown Area-->


                <span id="displayWarning" class="badge badge-danger badge-counter" style="font-size: 15px"></span>
            </a>
            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                <a class="dropdown-item text-center small text-gray-500" href="./issue_tracker.php">A New Issue Is
                    Registered</a>
            </div>
        </li>
        <!--Warning Ends Here-->
        ...
        <audio id="myAudio">
            <source src="./ajax/noti.mp3" type="audio/mpeg">
        </audio>
            ...
            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                    <div class="dropdown-list-image mr-3">
                        <img class="rounded-circle" src="./img/profile/<?php echo $data['profile_url'];?>" alt="">
  ...
  $.ajax({
    ...
    success: function(result) {
      ...
      {
      $('#displaystatus').text(i)
      $('#newassignment').text(result)
      i++
      current_notification=result
      }
...
*/
    ...
    /*This Section is for Warning and issue Tracking */
